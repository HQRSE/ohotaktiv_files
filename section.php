...
<?
global $USER;
if ($USER->IsAdmin()) echo $real_amount;
?>
<?
...
$sortField_2 = 'PROPERTY_IS_AVAILABLE'; // 2 поле сортировки по умолчанию
$sortOrder_2 = 'DESC'; // 2 направление сортировки по умолчанию
?>
			...
			<? $intSectionID = $APPLICATION->IncludeComponent(
				...
				array(
					...
					"ELEMENT_SORT_FIELD2" => $sortField_2, // $arParams["ELEMENT_SORT_FIELD2"],
					"ELEMENT_SORT_ORDER2" => $sortOrder_2, // $arParams["ELEMENT_SORT_ORDER2"],
